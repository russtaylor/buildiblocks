...
sed -i.bak s/obsidian_stairs/${block}_stairs/g ${originalPath}/stairs/${name}Stairs.java
...
sed -i.bak s/obsidian_slab/${block}_slab/g ${originalPath}/slabs/${name}Slab.java
